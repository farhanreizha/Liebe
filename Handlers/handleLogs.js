...
function handleLogs(client) {
   ...
   client.on("guildBannerAdd", (guild, bannerURL) => {
      const embed = new EmbedBuilder().setTitle("Server Got a new banner").setColor("Green").setImage(bannerURL)
   ...
   client.on("guildVanityURLAdd", (guild, vanityURL) => {
      const embed = new EmbedBuilder().setTitle("Vanity Link Added").setColor("Green").setDescription(`${guild.name} has a vanity link ${vanityURL}`)
   ...
   client.on("messagePinned", (message) => {
      const embed = new EmbedBuilder().setTitle("Message Pinned").setColor("Grey").setDescription(`${message} has been pinned by ${message.author}`)
   ...
   client.on("voiceChannelDeaf", (member, deafType) => {
      const embed = new EmbedBuilder()
         .setTitle("User Deafen")
         .setColor("Red")
         .setDescription(member.user.tag + " become deafen!")
   ...
   client.on("voiceChannelUndeaf", (member, deafType) => {
      const embed = new EmbedBuilder()
         ...
         .setColor("Green")
         .setDescription(member.user.tag + " become undeafend!")
   ...
   client.on("guildBanAdd", ({ guild, user }) => {
      const embed = new EmbedBuilder()
         ...
         .setColor("Red")
         .setDescription(`User: ${user} (\`${user.id}\`)\n\`${user.tag}\``, user.displayAvatarURL({ dynamic: true }))
